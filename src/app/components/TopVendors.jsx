...
const vendors = [
  {
    ...
    rating: "4.9",
    image:
      "https://images.unsplash.com/photo-1595152772835-219674b2a8a6?w=600&q=80&auto=format&fit=crop",
  },
  {
    name: "Grandma Foods",
    city: "Bangalore",
  ...
  },
  {
    ...
    rating: "4.7",
    image:
      "https://images.unsplash.com/photo-1546961329-78bef0414d7c?w=600&q=80&auto=format&fit=crop",
  },
  {
    name: "Homely Treats",
    city: "Mumbai",
  ...
  },
  {
    ...
    rating: "4.9",
    image:
      "https://images.unsplash.com/photo-1504593811423-6dd665756598?w=600&q=80&auto=format&fit=crop",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-500">
            ...
            Passionate Indian home chefs serving fresh homemade
            meals prepared with hygiene, authentic recipes,
          ...
          {vendors.map((vendor, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                {/* Verified Badge */}
                <div className="absolute top-4 right-4 bg-orange-500 text-white text-[11px] font-bold px-3 py-1 rounded-full shadow-lg">
              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <p className="text-[28px] font-black text-orange-500 leading-none">
                  ...
                  {/* Arrow Button */}
                  <button className="w-12 h-12 rounded-2xl bg-orange-500 hover:bg-orange-600 flex items-center justify-center text-white transition-all duration-300 shadow-lg shadow-orange-100 hover:scale-110">
                ...
                <Link
                  href="/vendor/shop"
                  className="mt-6 w-full h-[48px] rounded-2xl border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white text-sm font-bold transition-all duration-300 flex items-center justify-center gap-2"
                >
